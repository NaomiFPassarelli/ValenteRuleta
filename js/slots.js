var slotMachine = {
    ...
    show_won_state: function (n, e, t)
    {
        ...
        n ? ($('.spinResult #result').html("GANASTE!")) : $('.spinResult #result').html("PERDISTE");
    ...
    roundSpins: function()
    {
        ...
        var reels_1 = Math.floor((Math.random() * 6) + 1);
        var reels_2 = Math.floor((Math.random() * 6) + 1);
        var reels_3 = Math.floor((Math.random() * 6) + 1);
        //1: banana
        //2: 7
        //3: sandia
        //4: bar
        ...
        else if (reels_1 == reels_2 && reels_2 == reels_3 && reels_3 == 2) //todos 7
        {
            won = true;
            prize_id = 37;
